...
const std::map<ip_port, std::list<Vserver> > &ConfigParser::parse(const char *file_name)
{
    _f.open(file_name);
    if (!_f.good())
    {
        throw ConfigParser::ConfigParserException("Error: failed to open the file");
    }
    _parse_config_file();
    return _config;
}
...
void ConfigParser::_parse_root(std::istringstream &iss, Route &r)
{
    ...
    {
        throw ConfigParser::ConfigParserException("Error: Config file: server root");
    }
...
void ConfigParser::_parse_auto_index(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: server auto index");
    }
    parsed = parsed.substr(0, c);
    if (parsed == "on")
    {
    ...
    {
        throw ConfigParser::ConfigParserException("Error: Config file: Invalide value for autoindex, it should be "
                                                  "(on | off)");
    }
}
...
void ConfigParser::_parse_default_index(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: server default index");
    }
...
void ConfigParser::_parse_cgi_interpreter(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: route cgi interpreter");
    }
    parsed = parsed.substr(0, c);
...
void ConfigParser::_parse_cgi_extension(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: route cgi extension");
    }
    parsed = parsed.substr(0, c);
...
void ConfigParser::_parse_allowed_methods(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: route allowed methods");
    }
}
...
void ConfigParser::_parse_route_error_page(std::istringstream &iss, Route &r)
{
    ...
    {
        throw ConfigParser::ConfigParserException("Error: Config file: error status code should be a number");
    }
    ...
    if (c == std::string::npos)
    {
        ...
        throw ConfigParser::ConfigParserException("Error: Config file: route error page");
    }
...
void ConfigParser::_parse_route_redirection(std::istringstream &iss, Route &r)
{
    ...
    {
        std::cerr << "Error: Config file" << std::endl;
        throw ConfigParser::ConfigParserException("Error: Config file: redirection status code should be a number");
    }
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: route redirection");
    }
...
void ConfigParser::_parse_route_upload(std::istringstream &iss, Route &r)
{
    ...
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config file: route upload accepted");
    }
...
int ConfigParser::_parse_location(std::istringstream &curr_iss)
{
    ...
    if (temp != "{")
    {
        throw ConfigParser::ConfigParserException("Error: Config file: syntax error");
    }
...
int ConfigParser::_parse_server_names(std::istringstream &curr_iss)
{
    ...
    while (serv_name.length() != 0)
    {
        ...
        {
            throw ConfigParser::ConfigParserException("Error: Config file: server names");
        }
    }
    if (c == std::string::npos)
    {
        throw ConfigParser::ConfigParserException("Error: Config: syntax error");
    }
    return 0;
}
...
void ConfigParser::_parse_error_page(std::istringstream &iss)
{
    ...
    if (!str_is_number(parsed))
    {
        throw ConfigParser::ConfigParserException("Error: Config file: server error status code should be a number");
    }
    int err_code = std::strtol(parsed.c_str(), NULL, 10);
    iss >> parsed;
    size_t c = parsed.find(';');
...
void ConfigParser::_parse_redirection(std::istringstream &iss)
{
    ...
    if (!str_is_number(parsed))
    {
        throw ConfigParser::ConfigParserException("Error: Config file: server redirection status code should be a "
                                                  "number");
    }
    int status_code = std::strtol(parsed.c_str(), NULL, 10);
    iss >> parsed;
